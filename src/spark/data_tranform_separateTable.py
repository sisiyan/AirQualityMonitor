...
temperature_df2 = temperature_df.withColumnRenamed("Sample Measurement", "temperature").withColumnRenamed("State Name", "state_name").withColumnRenamed("County Name", "county_name").withColumnRenamed("Date GMT", "Date_GMT").withColumnRenamed("Time GMT", "Time_GMT")

temperature_df = temperature_df2.withColumn("latitude", df["Latitude"].cast(DoubleType())).withColumn("longitude", df["Longitude"].cast(DoubleType())).withColumn("temperature", df["temperature"].cast(DoubleType()))
